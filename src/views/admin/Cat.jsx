    ...
    return (
        <div className="px-2 lg:px-7 pt-5">
            ...
            <div className="flex flex-wrap w-full">
                                            ...
                                            <tr key={i}>
                                                ...
                                                <td className="py-1 px-4 font-medium whitespace-nowrap">
                                                    <div className="flex justify-start items-center gap-4">
                                                        <Link className="p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shdow-yellow-500/50">
                                                            <FaEdit />
                                                        </Link>
                                                        <Link className="p-[6px] bg-red-500 rounded hover:shadow-lg hover:shdow-red-500/50">
                                                            <FaTrash />
                                                        </Link>
                                                    </div>
                                                </td>
                ...
                <div className={`w-[320px] lg:w-5/12 translate-x-100 lg:relative lg:right-0 top-0 transition-all duration-500 fixed z-[9999] shadow-lg lg:shadow-none ${show ? 'right-0' : '-right-[340px]'}`}>
                        ...
                        <div className="bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
                            ...
                            <form>
                                <div className="flex flex-col w-full gap-1 mb-3">
                                    ...
                                    <input className="px-4 py-2 focus:border-indigo-500 outline-none bg-white border border-slate-700 rounded-md text-[#000000]" type="text" id="name" name="category_name" placeholder="Category Name" />
                                </div>
                                <div>
                                    <label className="flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed hover:border-indigo-100 w-full border-[#d0d2d6]" htmlFor="image">
                                        <span><FaImage /></span>
