...
const AdminDashboard = () => {
    const state = {
        series: [
            {
                name: "Orders",
                data: [72, 13, 56, 89, 45, 28, 34, 91, 67, 23, 78, 51]
            },
            {
                name: "Revenue",
                data: [65, 37, 82, 49, 23, 58, 76, 41, 94, 12, 67, 30]
            },
            {
                name: "Sellers",
                data: [43, 79, 24, 58, 15, 68, 37, 91, 52, 86, 21, 74]
            }
        ],
        options: {
            color: ['#181ee8', '#181ee8'],
        ...
        <div className='px-2 md:px-7 py-5'>
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                <div className='flex justify-between items-center p-5 bg-[#fde2ff] rounded-md gap-3'>
                    ...
                    <div className='w-[40px] h-[47px] rounded-full bg-[#760072] flex justify-center items-center text-xl'>
                                ...
                                <li className='mb-3 ml-6'>
                                    <div>
                                        <div className='flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6px] bg-[#4c7fe2] rounded-full z-10'>
                                            <img className='w-full rounded-full h-full shadow-lg' src="http://localhost:3000/images/admin.jpg" alt="admin headshot" />
                                        </div>
                        ...
                        <tbody>
                            {
                                [1,2,3,4,5].map((data, i) => {
                                    return (
                                        <tr key={i}>
                                            <td className='py-3 px-4 font-medium whitespace-nowrap'>#34343</td>
